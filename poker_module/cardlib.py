...
class PokerHand:
    ...
    def check_diff_pairs(cards):
        ...
        list_of_cards_twos = [
            twos,
            cards[0:7],
        ]  # Creates list with the pair/pairs in the first index/indices and then the cards
        list_of_cards_threes = [
            threes,
            cards[0:7],
        ]  # Creates list with the threes in the first index and then the cards
